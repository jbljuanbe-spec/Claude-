...
export const RANGOS = [
  { min: 1380, titulo: 'Leyenda Inmortal',      emoji: '🌟', desc: 'Tu nombre está en los libros de texto. Los niños juegan a ser tú.' },
  { min: 1140,  titulo: 'Maestro Pokémon',       emoji: '👑', desc: 'Llegaste a la cima y te quedaste allí. Nadie discute tu lugar.' },
  { min: 950,  titulo: 'Campeón Regional',      emoji: '🏆', desc: 'Levantaste la copa. La región entera coreó tu nombre.' },
  { min: 860,  titulo: 'Élite del Circuito',    emoji: '🥇', desc: 'Uno de los grandes de tu generación, aunque el título máximo se te resistió.' },
  { min: 740,  titulo: 'Profesional Respetado', emoji: '🎖️', desc: 'Viviste de esto con dignidad. Muchos matarían por tu carrera.' },
  { min: 590,  titulo: 'Veterano de Circuito',  emoji: '🎽', desc: 'Aguantaste años ahí arriba sin llegar a lo más alto.' },
  { min: 450,  titulo: 'Entrenador Sólido',     emoji: '⚡', desc: 'Buenos momentos, buen equipo, ningún titular de portada.' },
  { min: 330,  titulo: 'Promesa Incumplida',    emoji: '🌱', desc: 'Todos decían que ibas a ser el mejor. La vida dijo otra cosa.' },
