...
export const LOGROS = [
  ...
  { id: 'dominio', emoji: '👑', nombre: 'Dinastía', desc: () => 'Tres o más títulos: no fue suerte.', pista: 'Tres títulos en una misma carrera.', cond: e => e.titulos.length >= 3 },
  { id: 'ochomedallas', emoji: '🎖️', nombre: 'Las ocho medallas', desc: e => `Completaste el circuito de ${e.regionNombre}.`, pista: 'Consigue las 8 medallas de una región.', cond: e => e.medallas >= 8 },
  { id: 'coleccionista', emoji: '📦', nombre: 'Coleccionista', desc: e => `${e.capturasTotales} Pokémon distintos pasaron por tu equipo.`, pista: 'Doce Pokémon distintos en tu equipo.', cond: e => e.capturasTotales >= 12 },
  { id: 'legendario', emoji: '⚡', nombre: 'Domador de leyendas', desc: () => 'Capturaste un Pokémon legendario. Casi nadie puede decirlo.', pista: 'Captura un Pokémon legendario.', cond: e => e.equipo.some(p => p.rareza === 'legendario') },
  { id: 'pseudo', emoji: '🐲', nombre: 'Criador de dragones', desc: () => 'Criaste un pseudolegendario desde su primera etapa.', pista: 'Evoluciona un pseudolegendario.', cond: e => e.equipo.some(p => p.rareza === 'pseudo' && p.etapa >= 2) },
  { id: 'fiel', emoji: '💚', nombre: 'Hasta el final', desc: () => 'Tu primer compañero siguió contigo toda la carrera.', pista: 'Retírate con tu primer compañero.', cond: e => e.equipo.some(p => p.uid === e.socio && !p.retirado) },
  ...
  { id: 'hierro', emoji: '🦾', nombre: 'De hierro', desc: () => 'Ni una sola lesión grave en toda la carrera. Otra pasta.', pista: 'Acaba sin lesiones crónicas.', cond: e => !e.flags.lesionCronica && e.stats.salud >= 55 },
  ...
  { id: 'sancionado', emoji: '⛔', nombre: 'El sancionado', desc: () => 'La federación te apartó del circuito. Volviste igual.', pista: 'Que te sancionen, y vuelve.', cond: e => !!e.flags.exsancionado },
  { id: 'nemesis', emoji: '⚔️', nombre: 'El duelo eterno', desc: e => `Le ganaste la carrera a ${e.rival.nombre} por ${e.rival.derrotasTuyas}-${e.rival.victoriasSuyas}.`, pista: 'Gánale a tu rival por tres o más.', cond: e => e.rival.derrotasTuyas > e.rival.victoriasSuyas && e.rival.derrotasTuyas >= 3 },
  ...
  { id: 'invicto', emoji: '📈', nombre: 'Récord impecable', desc: e => `${e.victorias}-${e.derrotas}: ganaste el triple de lo que perdiste.`, pista: 'Gana el triple de lo que pierdes.', cond: e => e.victorias > e.derrotas * 3 },
  ...
  { id: 'santuario', emoji: '🏞️', nombre: 'El santuario', desc: () => 'Fundaste un refugio para Pokémon retirados.', pista: 'Funda un refugio para retirados.', cond: e => !!e.flags.santuario },
  { id: 'maestro', emoji: '🌱', nombre: 'Maestro de una generación', desc: () => 'Formaste al que vino después de ti.', pista: 'Forma al que viene detrás de ti.', cond: e => !!e.flags.discipulo },
