...
export const LOGROS = [
  ...
  { id: 'puertas', emoji: '🔄', nombre: 'Puertas giratorias', desc: () => 'Consejero externo de Iberdrola. Dos reuniones al mes y un almuerzo.', cond: e => e.causaRetiro === 'puertas' },
  { id: 'expulsado', emoji: '🚫', nombre: 'Te echaron', desc: e => `${e.partidoNombre} te expulsó. Una tarde mala puede con veinte años buenos.`, cond: e => !!e.flags.expulsado },
  { id: 'imputado', emoji: '⚖️', nombre: 'El caso', desc: () => 'Acabaste imputado por el sobrecoste. La UCO a las ocho de la mañana.', cond: e => !!e.flags.imputado },
  { id: 'corrupto', emoji: '💼', nombre: 'La consultora que no existía', desc: () => 'Metiste mano en una adjudicación y salió bien. Eso es lo peor de todo.', cond: e => !!e.flags.corrupto && !e.flags.imputado },
  { id: 'limpio', emoji: '🧹', nombre: 'Manos limpias', desc: () => 'Paraste el fango y llevaste un sobrecoste a Fiscalía. Nadie te lo agradeció.', cond: e => !!e.flags.limpio && !e.flags.corrupto },
  { id: 'plato', emoji: '🎙️', nombre: 'Del escaño al plató', desc: () => 'Cambiaste la política por una tertulia diaria. Se te daba mejor.', cond: e => e.causaRetiro === 'plato' },
